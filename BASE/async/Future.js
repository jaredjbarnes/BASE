BASE.require(["BASE.util.Notifiable", "BASE.util.ObservableEvent"], function () {

    BASE.namespace("BASE.async");

    BASE.async.Future = (function (Super) {
                ...
                request: function () {
                    getValue(function (value) {
                        ...
                        if (_state !== _canceledState &&
                            ...
                            _state = _loadedState;
                            _value = value;
                            self.notify(new BASE.util.ObservableEvent("success"));
                        ...
                        if (_state !== _canceledState &&
                            ...
                            _state = _errorState;
                            _error = err;
                            self.notify(new BASE.util.ObservableEvent("error"));
                            self.notify(new BASE.util.ObservableEvent("complete"));
                        }
                    });
